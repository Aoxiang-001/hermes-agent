...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "NIM_CREDENTIALS", "NIM_INSTANCES", "NIM_APP_KEY", "NIM_ACCOUNT", "NIM_TOKEN",
    "NIM_ALLOWED_USERS", "NIM_ALLOW_ALL_USERS", "NIM_GROUP_POLICY", "NIM_GROUP_ALLOWLIST",
    "NIM_HOME_CHANNEL", "NIM_HOME_CHANNEL_NAME", "NIM_BRIDGE_COMMAND", "NIM_MEDIA_MAX_MB", "NIM_DEBUG",
